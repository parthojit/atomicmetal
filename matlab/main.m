...
function v_min_Callback(hObject, eventdata, handles)
% hObject    handle to v_min (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of v_min as text
%        str2double(get(hObject,'String')) returns contents of v_min as a double


% --- Executes during object creation, after setting all properties.
function v_min_CreateFcn(hObject, eventdata, handles)
% hObject    handle to v_min (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function p_high_Callback(hObject, eventdata, handles)
% hObject    handle to p_high (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of p_high as text
%        str2double(get(hObject,'String')) returns contents of p_high as a double


% --- Executes during object creation, after setting all properties.
function p_high_CreateFcn(hObject, eventdata, handles)
% hObject    handle to p_high (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function scan_rate_Callback(hObject, eventdata, handles)
% hObject    handle to scan_rate (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of scan_rate as text
%        str2double(get(hObject,'String')) returns contents of scan_rate as a double


% --- Executes during object creation, after setting all properties.
function scan_rate_CreateFcn(hObject, eventdata, handles)
% hObject    handle to scan_rate (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function n_scans_Callback(hObject, eventdata, handles)
% hObject    handle to n_scans (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of n_scans as text
%        str2double(get(hObject,'String')) returns contents of n_scans as a double


% --- Executes during object creation, after setting all properties.
function n_scans_CreateFcn(hObject, eventdata, handles)
% hObject    handle to n_scans (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
